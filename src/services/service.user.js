...
const alterarCadastroService = (id, name, username, password, email, avatar, background) =>
  newCliente.findOneAndUpdate({ _id: id }, { name, username, password, email, avatar, background });
